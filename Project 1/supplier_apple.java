...
public class supplier_apple extends Agent {
    List<String> productos = Arrays.asList("Iphone 12", "MacBook Pro 2019");
    String db;
    String producto;
    String AgentName = "Apple";
    int ID_proveedor = 3;
    ...
    private void Surtir(String title) {
        try {
