...
public class seller_amazon extends Agent {
    ...
    private void ConnectDB() {
        ...
        try {
            ...
            // Connect to DB
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/kbs_amazon", "root", "root");
    ...
    private class Resurtir extends OneShotBehaviour {
        ...
        public void action() {
            ...
            cfp.setContent(resurtirProd.nombre + "@kbs_amazon");
